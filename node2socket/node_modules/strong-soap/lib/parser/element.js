...
var Element = function () {
  ...
  _createClass(Element, [{
    ...
    key: 'startElement',
    value: function startElement(stack, nsName, attrs, options) {
    ...
    key: 'endElement',
    value: function endElement(stack, nsName) {
    ...
    key: '_qnameFor',
    value: function _qnameFor(stack, nsName, attrs, options) {
    ...
    key: 'unexpected',
    value: function unexpected(name) {
    ...
    key: 'getNamespaceURI',
    value: function getNamespaceURI(prefix) {
    ...
    key: 'getTargetNamespace',
    value: function getTargetNamespace() {
      if (this.targetNamespace) {
    ...
    key: 'resolveSchemaObject',
    value: function resolveSchemaObject(schemas, elementType, nsName) {
      var qname = QName.parse(nsName);
      var nsURI;
