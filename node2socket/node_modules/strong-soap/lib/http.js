...
var HttpClient = function () {
  ...
  _createClass(HttpClient, [{
    key: 'buildRequest',
    value: function buildRequest(rurl, data, exheaders, exoptions) {
    ...
    key: 'handleResponse',
    value: function handleResponse(req, res, body) {
    ...
    key: 'isNtlmAuthRequired',
    value: function isNtlmAuthRequired(ntlmSecurity, methodName) {
    ...
    key: 'request',
    value: function request(rurl, data, callback, exheaders, exoptions) {
      var self = this;
